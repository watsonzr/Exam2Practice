...
def practice_problem3c(sequence):
    ...
    for i in range(len(sequence)):
        if sequence[i] == 0:
            list_of_zero_index = list_of_zero_index + [i]
    return list_of_zero_index
...
def practice_problem3d(sequence):
    ...
    list_of_zero_index = practice_problem3c(sequence)
    if len(list_of_zero_index) == 0:
        return -1
    else:
        return list_of_zero_index[0]
